...
create table tbl_member_follow( #회원 팔로우/팔로잉
    #
    id bigint unsigned auto_increment primary key,
...
create table tbl_member_notification( #게시 알림
    #
    id bigint unsigned auto_increment primary key,
...
create table tbl_member_pick( #인기 추천
    #
...
create table tbl_member_wish; #회원 위시리스트
#
...
create table tbl_board_hash( #거래 해시태그
    id       bigint unsigned auto_increment primary key,
    hash_board_id bigint unsigned not null,
    constraint fk_wish_board_id foreign key (hash_board_id) references tbl_board (id)
#
);
create table tbl_board_payment; #개인간거래내역
#

#
create table tbl_car( #자동차
#
id     bigint unsigned auto_increment primary key,
...
create table tbl_ev_charger( #EV충전기
#
charger_location
);
#
create table tbl_cpo_employee; #관리자
#

#
create table tbl_v_to_g_payment; #VtoG거래내역
#

#
create table tbl_review; #리뷰
#

#
create table tbl_comment ( #댓글
#
id     bigint unsigned auto_increment primary key,
